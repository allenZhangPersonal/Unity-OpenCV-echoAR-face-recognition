namespace OpenCvSharp.Demo
{
	...
	public class FaceRecognizerScene : UnityEngine.MonoBehaviour
	{
		...
		protected virtual void Awake()
		{
			...
			// label names
			//names = new string[] {"allen", "andy", other"};
		}
		...
		void Start()
		{
			string [] roots = {UnityEngine.Application.dataPath, "Images"};
		...
		void inferFace()
		{
			UnityEngine.Debug.Log("Current base directory: " + UnityEngine.Application.dataPath);
			...
			foreach (var faceRect in rawFaces)
			{
				...
				UnityEngine.Debug.Log("Distance from sample: " + confidence);
